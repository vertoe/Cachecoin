...
HEADERS += src/qt/cachecoingui.h \
    ...
    src/qt/cachecoinaddressvalidator.h \
    src/qt/serveur.h\
    src/alert.h \
    src/addrman.h \
    src/base58.h \
...
SOURCES += src/qt/cachecoin.cpp src/qt/cachecoingui.cpp \
    ...
    src/qt/cachecoinaddressvalidator.cpp \
    src/qt/serveur.cpp \
    src/alert.cpp \
    src/version.cpp \
    src/sync.cpp \
    ...
    src/qt/cachecoinstrings.cpp \
    src/qt/cachecoinamountfield.cpp \
    src/wallet.cpp \
    src/keystore.cpp \
...
# also add new translations to src/qt/cachecoin.qrc under translations/
TRANSLATIONS = $$files(src/qt/locale/cachecoin_*.ts)
...
win32:DEFINES += WIN32
win32:RC_FILE = src/qt/res/cachecoin-qt.rc
...
macx:ICON = src/qt/res/icons/cachecoin.icns
macx:TARGET = "Cachecoin-Qt"
