...
{
    return GetBoolArg("-testnet", false) ? 12224 : 2224;
}
...
string HTTPPost(const string& strMsg, const map<string,string>& mapRequestHeaders)
{
    ostringstream s;
    s << "POST / HTTP/1.1\r\n"
      << "User-Agent: cachecoin-json-rpc/" << FormatFullVersion() << "\r\n"
      << "Host: 127.0.0.1\r\n"
...
//
// JSON-RPC protocol.  Cachecoin speaks version 1.0 for maximum compatibility,
...
void ThreadRPCServer(void* parg)
{
    ...
    RenameThread("cachecoin-rpclist");
...
void ThreadRPCServer2(void* parg)
{
    ...
    if (mapArgs["-rpcpassword"] == "")
    {
        ...
        string strWhatAmI = "To use cachecoind";
...
void ThreadRPCServer3(void* parg)
{
    ...
    RenameThread("cachecoin-rpchand");
