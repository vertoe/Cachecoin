...
#ifndef _CACHECOINRPC_H_
#define _CACHECOINRPC_H_ 1
...
enum RPCErrorCode
{
    ...
    // P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  // Cachecoin is not connected
...
/**
 * Cachecoin RPC command dispatcher.
 */
class CRPCTable
{
private:
