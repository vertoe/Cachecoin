...
namespace Checkpoints
{
    ...
    // cachecoin: synchronized checkpoint (centrally broadcasted)
    ...
    // cachecoin: get last synchronized checkpoint
    ...
    // cachecoin: only descendant of current sync-checkpoint is allowed
    ...
    // cachecoin: reset synchronized checkpoint to last hardened checkpoint
...
// cachecoin: sync-checkpoint master key
...
// cachecoin: verify signature of sync-checkpoint message
...
// cachecoin: process synchronized checkpoint
