...
void Shutdown(void* parg)
{
    ...
    RenameThread("cachecoin-shutoff");
...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        ...
        "  -port=<port>           " + _("Listen for connections on <port> (default: 2225 or testnet: 12225)") + "\n" +
        ...
        "  -rpcport=<port>        " + _("Listen for JSON-RPC connections on <port> (default: 2224 or testnet: 12224)") + "\n" +
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    // Make sure only a single Cachecoin process is using the data directory.
    ...
    if (mapArgs.count("-reservebalance")) // cachecoin: reserve balance amount
    {
    ...
    if (mapArgs.count("-checkpointkey")) // cachecoin: checkpoint master priv key
    {
    ...
    AddOneShot(string("78.46.66.139"));
    AddOneShot(string("188.40.57.201"));
