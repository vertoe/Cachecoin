    ...
    model(0)
{
    ...
    ui->lineEditCoinControlChange->setPlaceholderText(tr("Enter a Cachecoin address (e.g. CrXW1RKLDe8VMNwTwLwSiKuATN5M74EL85)"));
#endif
    addEntry();
    ...
    // Coin Control
    ui->lineEditCoinControlChange->setFont(GUIUtil::cachecoinAddressFont());
...
void SendCoinsDialog::on_sendButton_clicked()
{
    ...
    {
        formatted.append(tr("<b>%1</b> to %2 (%3)").arg(CachecoinUnits::formatWithUnit(CachecoinUnits::CACH, rcp.amount), Qt::escape(rcp.label), rcp.address));
    }
    ...
    case WalletModel::AmountWithFeeExceedsBalance:
        QMessageBox::warning(this, tr("Send Coins"),
            ...
            arg(CachecoinUnits::formatWithUnit(CachecoinUnits::CACH, sendstatus.fee)),
            QMessageBox::Ok, QMessageBox::Ok);
        break;
 ...
 void SendCoinsDialog::coinControlChangeEdited(const QString & text)
 {
     if (model)
     {
         ...
         else if (!CCachecoinAddress(text.toStdString()).IsValid())
         {
             ...
             ui->labelCoinControlChangeLabel->setText(tr("WARNING: Invalid Cachecoin address"));
         }
         else
         {
